...
import (
	...
	mtcrypto "github.com/mantlenetworkio/mantle/mt-service/crypto"
	"github.com/mantlenetworkio/mantle/mt-signer/client"
...
func NewConfig(cfg CLIConfig, l log.Logger) (Config, error) {
	...
	signerFactory, from, err := mtcrypto.SignerFactoryFromConfig(l, cfg.PrivateKey, cfg.Mnemonic, hdPath, cfg.SignerCLIConfig)
	if err != nil {
